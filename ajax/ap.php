                        ...
                        if (!empty($get_videos)) {
                            ...
                            foreach ($get_videos->items as $key => $video) {
                                ...
                                $array_data = array(
                                    ...
                                    'TAGS' => $tags,
                                    'DURATION' => $duration,
                                    'MAIN_DURATION' => $video->contentDetails->duration,
    ...
    if (!empty($_POST['videos'])) {
        ...
        foreach ($_POST['videos'] as $key => $data_fro_ajax) {
            ...
            if ($insert) {
                ...
                if (checkIfVideoSort($data_fro_ajax['main_duration'])) {

                    $YP_url = '';
                    try {
                        $YP_url = getYotubeRapidAPIData("https://www.youtube.com/shorts/" . $data_fro_ajax['video_id']);
                        if (!empty($YP_url)) {
                            ...
                            if (!empty($videoContent) && $videoContent['status'] == 200) {
                                ...
                                file_put_contents($newThumbnail, file_get_contents($thumb));
